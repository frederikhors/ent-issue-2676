...
func (uu *UserUpdate) check() error {
	if _, ok := uu.mutation.TeamID(); uu.mutation.TeamCleared() && !ok {
		return errors.New(`ent: clearing a required unique edge "User.team"`)
	}
	return nil
}
...
func (uuo *UserUpdateOne) check() error {
	if _, ok := uuo.mutation.TeamID(); uuo.mutation.TeamCleared() && !ok {
		return errors.New(`ent: clearing a required unique edge "User.team"`)
	}
	return nil
}
